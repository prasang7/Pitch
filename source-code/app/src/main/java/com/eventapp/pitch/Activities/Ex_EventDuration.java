 ...
 */
public class Ex_EventDuration extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_EventDuration.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_eventduration);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_EventDuration.this, "Event duration field can't be left empty. Right?", Toast.LENGTH_LONG).show();
        Vibrator v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(100);
    }

    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_EventDuration.this,SharedPreferenceMethods.EVENT_DURATION,et_answer.getText().toString());
    }
