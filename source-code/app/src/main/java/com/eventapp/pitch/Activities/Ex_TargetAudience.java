 ...
 */
public class Ex_TargetAudience extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_TargetAudience.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_target);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_TargetAudience.this, "Target audience field can't be left empty. Right?", Toast.LENGTH_LONG).show();
        Vibrator v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(100);
    }

    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_TargetAudience.this,SharedPreferenceMethods.TARGET_AUDIENCE,et_answer.getText().toString());
    }
