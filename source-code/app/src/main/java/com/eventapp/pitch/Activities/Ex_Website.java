 ...
 */
public class Ex_Website extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_Website.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_website);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_Website.this, "Wensite url can't be left empty. Right?", Toast.LENGTH_LONG).show();
        Vibrator v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(100);
    }

    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_Website.this, SharedPreferenceMethods.WEBSITE, et_answer.getText().toString());
    }
