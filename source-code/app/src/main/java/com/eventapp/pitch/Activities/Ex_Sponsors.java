 ...
 */
public class Ex_Sponsors extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_Sponsors.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_sponsors);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_Sponsors.this, "Sponsor's field can't be left empty. Right?", Toast.LENGTH_LONG).show();
        Vibrator v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(100);
    }

    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_Sponsors.this,SharedPreferenceMethods.SPONSOR_DETAIL,et_answer.getText().toString());
    }
