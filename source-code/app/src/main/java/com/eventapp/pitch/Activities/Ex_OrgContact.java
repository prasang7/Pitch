 ...
 */
public class Ex_OrgContact extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_OrgContact.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_orgcontact);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_OrgContact.this, "Organizer's contact field can't be left empty. Right?", Toast.LENGTH_LONG).show();
        Vibrator v = (Vibrator) this.getSystemService(Context.VIBRATOR_SERVICE);
        v.vibrate(100);
    }

    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_OrgContact.this,SharedPreferenceMethods.ORG_CONTACT,et_answer.getText().toString());
    }
