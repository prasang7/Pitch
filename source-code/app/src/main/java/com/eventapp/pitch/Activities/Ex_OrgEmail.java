 ...
 */
public class Ex_OrgEmail extends Activity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (emptyString()) {
                    ...
                    saveUsername();
                    Intent i = new Intent(Ex_OrgEmail.this, InputFromUser.class);
                    startActivity(i);
    ...
    void init() {
        setContentView(R.layout.ex_orgemail);
    ...
    void emptyAlert() {
        Toast.makeText(Ex_OrgEmail.this, "Organizer's email field can't be left empty. Right?", Toast.LENGTH_LONG).show();
    ...
    void saveUsername() {
        SharedPreferenceMethods.setString(Ex_OrgEmail.this,SharedPreferenceMethods.ORG_EMAIL,et_answer.getText().toString());
    }
